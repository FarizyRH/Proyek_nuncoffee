    ...
    <div class="mobile-nav__content">
        ...
        <div class="logo-box">
            <a href="index.html" aria-label="logo image">
                <img src="{{asset('01-html-file/assets/images/logo/3.svg')}}" width="100" height="60"  alt="Logo" />
            </a>
        </div>
        ...
        <div class="container">
            <div class="site-footer__top-inner">
                <div class="site-footer__logo">
                    <a href="index.html"><img src="{{asset('01-html-file/assets/images/logo/3.svg')}}"  class="h-[75px] w-[100px]" alt=""></a>
                </div>

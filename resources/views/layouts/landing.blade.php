...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('01-html-file/assets/images/logo/4.png')}}" />
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('01-html-file/assets/images/logo/4.png')}}" />
